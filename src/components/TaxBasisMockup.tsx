...
const propertyKey = (value: string) => value.toLocaleUpperCase().replace(/[^A-Z0-9]/g, '');
...
export function TaxBasisMockup() {
  ...
  const toggleMember = (groupId: string, property: PropertySchedule) => setGroups((current) => {
    ...
    const member: GroupMember = { property: property.property, entity: property.entity, city: '', state: '', zip: '', units: '' };
